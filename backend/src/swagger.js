      ...
      schemas: {
        Clinic: {
          ...
          properties: {
            ...
            perVisitCostTier: { type: 'string', enum: ['low', 'moderate', 'high'] },
            ...
            badges: {
              type: 'array',
              items: { type: 'string', enum: ['best-value', 'top-rec', 'high-visits', 'new'] },
              description: 'Normalized badge tags. Empty array if no badges apply.',
              example: ['best-value', 'top-rec'],
            },
          },
        },
        Error: {
